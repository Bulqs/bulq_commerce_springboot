...
import com.bulq.bulq_commerce.repositories.WalletRepository;
import com.bulq.bulq_commerce.util.constants.InsufficientBalanceException;
...
public class WalletService {
    ...
    @Transactional
    public void deductFromWallet(Long walletId, Order order, BigDecimal amount) throws InsufficientBalanceException {
